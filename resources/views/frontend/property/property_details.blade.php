        ...
        <section class="property-details property-details-one">
            <div class="auto-container">
                        ...
                        <div class="author-info clearfix">
                            <div class="author-box pull-left">
                                @if ($property->agent_id == Null)
                                    <figure class="author-thumb"><img src="{{ asset('uploads/avatar-3.png') }}" alt=""></figure>
                                    <h6>Admin</h6>
                                @else
                                    <figure class="author-thumb"><img src="{{ (!empty($property->user->photo)) ? asset('uploads/agent_images/'.$property->user->photo) :  asset('uploads/no_image.jpg') }}" alt=""></figure>
                        ...
                        <div class="property-details-content">
                            <div class="carousel-inner">
                                <div class="single-item-carousel owl-carousel owl-theme owl-dots-none">
                                    ...
                                    <figure class="image-box"><img src="{{ asset('uploads/property/multi_img/'.$img->photo_name) }}" alt=""></figure>
                                    @endforeach
                                </div>
                            </div>
                            <div class="discription-box content-widget">
                                ...
                                <div class="text">{!! $property->long_desp !!}</p>
                                </div>
                            </div>
                        ...
                        <div class="google-map-area">
                            ...
                            <div class="statistics-box content-widget">
                                ...
                                <figure class="image-box">
                                    <iframe width="700" height="415" src="{{ $property->property_video }}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                                </figure>
                            </div>
                ...
                <div class="similar-content">
                    ...
                    <div class="row clearfix">
                        @foreach ($similarProperty as $item)
                            
        <div class="col-lg-4 col-md-6 col-sm-12 feature-block">
                <div class="feature-block-one wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                    <div class="inner-box">
                        <div class="image-box">
                            <figure class="image"><img src="{{ asset('uploads/property/thambnail') }}/{{ $item->property_thambnail }}" alt=""></figure>
                            ...
                            <div class="author-info clearfix">
                                <div class="author pull-left">
                                    @if ($item->agent_id == Null)
                                        ...
                                        <h6>Admin</h6>
                                    @else
                                        <figure class="author-thumb"><img src="{{ (!empty($item->user->photo)) ? asset('uploads/agent_images/'.$item->user->photo) :  asset('uploads/no_image.jpg') }}" alt=""></figure>
