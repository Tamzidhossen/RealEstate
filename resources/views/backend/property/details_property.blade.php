            ...
            <div class="card-body">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
        <img src="{{ asset('uploads/property/thambnail') }}/{{ $property->property_thambnail }}" style="width: 100px; height: 70px;">
                        </td>
                    </tr>
                    <tr>
                        <td>Status</td>
                        <td>
        <span class="badge rounded-pill bg-{{ $property->status ==1?'success':'danger' }}">{{ $property->status==1?'Active':'Deactive' }}</span>
                        </td>
                    </tr>
                </tbody>
                    </table>
