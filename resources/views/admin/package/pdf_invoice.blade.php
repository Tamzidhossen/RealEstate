    ...
    <tr>
        <td>
          <p class="font" style="margin-left: 20px;">
           <strong>Name:</strong> {{ $packageHistory->rel_to_user->name }} <br>
           <strong>Email:</strong> {{ $packageHistory->rel_to_user->email }} <br>
           <strong>Phone:</strong> {{ $packageHistory->rel_to_user->phone }} <br>
           
           <strong>Address:</strong>{{ $packageHistory->rel_to_user->address }}  
  ...
  <table width="100%">
    ...
    <tbody>
      ...
      <tr class="font">
        ...
        <td align="center">$ {{ $packageHistory->package_price }}</td>
        <td align="center">$ {{ $packageHistory->package_price }}</td>
