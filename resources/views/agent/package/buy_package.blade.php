...
<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        <a href="{{ route('buy.package') }}" class="btn btn-inverse-info">Add Package</a>
    </ol>
</nav>
            ...
            <div class="card-body">
                ...
                <div class="col-md-4 stretch-card grid-margin grid-margin-md-0">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-grid">
        <a href="{{ route('buy.business.plan') }}" class="btn btn-success mt-4">Buy Now</a>
                        </div>
                    </div>
                    </div>
                </div>
                <div class="col-md-4 stretch-card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-grid">
        <a href="{{ route('buy.professional.plan') }}" class="btn btn-primary mt-4">Buy Now</a>
                        </div>
                    </div>
                    </div>
                </div>
