...
<!-- Start All Property Updated  -->
<div class="col-md-12 col-xl-12 middle-wrapper">
    <div class="row">
        <div class="card">
            <div class="card-body">
                <h6 class="card-title">Edit Property</h6>
                <form method="POST" action="{{ route('update.agentproperty') }}" id="myForm" enctype="multipart/form-data">
                    @csrf
    ...
    <div class="row">
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('update.agentproperty.thambnail') }}" id="myForm" enctype="multipart/form-data">
                    @csrf
...
<!-- Start Property Multi Image Show -->
<div class="col-md-12 col-xl-12 middle-wrapper mt-3">
    <div class="row">
        <div class="card">
            <div class="card-body">
                <h6 class="card-title">Edit Multi Images</h6>
                <form method="POST" action="{{ route('update.agentproperty.multiimage') }}" id="myForm" enctype="multipart/form-data">
                    @csrf
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $key+1 }}</td>
                                    <td>
                                        <img src="{{ asset('uploads/property/multi_img') }}/{{ $img->photo_name }}">
                                    </td>
                                    <td><input type="file" name="multi_img[{{ $img->id }}]" class="form-control"></td>
                                    <td>
                                        <input type="submit" class="btn btn-primary" value="Update Image">
                                        <a href="{{ route('delete.agentproperty.multiimage', $img->id) }}" class="btn btn-danger" id="delete" >Delete</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
                ...
                {{-- Add MultiImage --}}
                <form method="POST" action="{{ route('store.agentnew.multiimage') }}" id="myForm" enctype="multipart/form-data">
                    @csrf
...
<!-- End Property Multi Image Show -->

<!-- Start Property Facility Edit -->
<div class="col-md-12 col-xl-12 middle-wrapper mt-3">
    <div class="row">
        <div class="card">
            <div class="card-body">
                <h6 class="card-title">Edit Property Facility</h6>
                <form method="POST" action="{{ route('update.agentproperty.facilities') }}" id="myForm" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="id" value="{{ $property->id }}">
    ...
    <option value="Bank" {{ $item->facility_name == 'Bank'? 'selected':'' }}>Bank</option>
                                ...
                                <div class="form-group col-md-4" style="padding-top: 20px; padding-bottom: 20px; padding-left: 0px;">
...
<!-- End Property Property Facility Edit -->
