...
<div class="row profile-body">
    ...
    <div class="card rounded">
        ...
        <div class="d-flex align-items-center justify-content-between mb-2">
            <div>
                <img class="wd-100 ht-100 rounded-circle" src="{{ (!empty($profileData->photo)) ? asset('uploads/agent_images/'.$profileData->photo) :  asset('uploads/no_image.jpg') }}" alt="profile">
        ...
        <div class="row">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('agent.profile.store') }}" method="POST" class="forms-sample" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="my-2"><img class="wd-80 ht-80 rounded-circle" src="{{ (!empty($profileData->photo)) ? asset('uploads/agent_images/'.$profileData->photo) :  asset('uploads/no_image.jpg') }}" id="blah" alt="" ></div>
                        </div>
